...
function selectOption(option) {
    ...
    if (option === 'yes') {
        ...
        replaceImageWithGif(function() {
            ...
            setTimeout(function() {
                window.location.href = 'message_index.html';
            }, 3010); // Wait for 3.8 seconds
        });
    } else {
...
function replaceImageWithGif(callback) {
    ...
    giftBoxImage.src = 'giftbox.gif'; // Assuming the gift box image is named "giftbox.gif"
...
function displayCat() {
    ...
    catImage.src = 'still_giftbox.gif'; // Assuming the cat image is named "cat.gif"
    // Set alternative text for the image (for accessibility)
    catImage.alt = 'Cat';
